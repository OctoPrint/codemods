...
class SetConstructorToLiteral(CodeMod):
    ...
    def leave_Call(
        ...
        if m.matches(updated_node.func, m.Name("set")) and updated_node.args:
            if len(updated_node.args) == 1 and isinstance(
                updated_node.args[0].value, cst.GeneratorExp
            ):
                # generator
                ...
                for arg in updated_node.args:
                    ...
                    elements.append(cst.Element(value=arg.value, comma=comma))
